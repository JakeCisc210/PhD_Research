function static_money_density_moneyline(money_density,gamma,isColored)
    ...
    arguments
        money_density = @(p,center,spread) double_stunted_gaussian(p,.5,.1); 
        gamma = @(p,center,spread) double_stunted_gaussian_gamma(p,.5,.1);
        isColored = 0;
    end
